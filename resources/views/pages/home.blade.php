		...
		<div class="home_left">
			<div class="menu_left">
				<h2 class="tit_left  visible-xs visible-sm visible-md visible-lg">
					<a href="{{URL::to('trangchu')}}" title="Danh mục sản phẩm">Danh mục sản phẩm</a>
				</h2>
